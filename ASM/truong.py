...
def xacnhan(thong_bao):
    while True:
        tra_loi = input(thong_bao +"(Y/N): ").strip().upper()
        if tra_loi == 'Y':
            return True
        elif tra_loi == 'N':
            print("Đã hủy")
...
def menu():
    while True:
        ...
        print("5. Xóa")
        print("6. Sắp xếp")
        print("7. Tìm kiếm sinh viên theo tháng")
        print("8. Tìm kiếm sinh viên theo chuyên ngành")
        print("9. Tìm kiếm sinh viên theo ngày sinh")
        print("10. Tìm kiếm sinh viên theo năm sinh")
        print("0. Thoát")
